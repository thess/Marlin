 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "2.0.x-MK2S"
   ...
   */
  #define MACHINE_NAME "Prusa i3 MK2S"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/thess/MarlinFirmware"

  /**
   * Default generic printer UUID.
   */
  #define DEFAULT_MACHINE_UUID "56d05f73-5780-4d3f-ab55-f942a94a8eb7"
